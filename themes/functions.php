...
function enqueue_fap() {
  if ( is_page_template('template-fap.php') || is_page_template('template-fad.php' ) || is_page_template('template-fap-result.php' )  || is_page_template('template-fad-result.php' ) ) {
	  
    wp_enqueue_style('new-design-style', get_stylesheet_directory_uri() . '/design2021/css/style.css');
	wp_enqueue_style('new-design-header', get_stylesheet_directory_uri() . '/design2021/css/header.css');
	
  }
}
add_action( 'wp_enqueue_scripts', 'enqueue_fap' );
...
//needed to make the cf7 shortcodes pull through
