 ...
 */
	...
	function simple_add_to_cart( $atts ) {
		...
		/**
	 * Display quantity + cart button.
	 *
	 * @param array $atts Attributes.
	 * @return string
	 */
	 add_shortcode( 'quantity_add_to_cart', 'quantity_add_to_cart' );
	 
	function quantity_add_to_cart( $atts ) {
		global $post;
		...
		if ( $product->is_in_stock() ) { ?>
			...
			<form class="cart" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
				...
				<button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="button product_type_simple add_to_cart_button ajax_add_to_cart">BUY</button>
	...
	function simple_price( $atts ) {
		...
		echo '<div class="single-product-prices ' . esc_attr( $atts['class'] ) . '" style="' . ( empty( $atts['style'] ) ? '' : esc_attr( $atts['style'] ) ) . '">';
			...
			echo "<span class='no-tax-price'>" .$product->get_price_html() . "</span>";
			// @codingStandardsIgnoreEnd
			
			
			if(get_field('price_including_vat', $atts['id'])){
...
/**
	 * Display woocommerce feature image
	 */
	 

	 
	 add_shortcode( 'simple_image', 'simple_image' );
	 
	function simple_image( $atts ) {
